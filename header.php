...
<link rel="shortcut icon" type="image/x-icon" href="http://kaibots.com/favicon.ico"/>
 ...
 <body>
<nav class="navbar navbar-default nav-properties" style="width:70%;margin:10px auto;">
...
<a href="?language=es_LA"><img src="images/flags/MX.png"></a>
<a href="?language=en_US"><img src="images/flags/US.png"></a>
</div>
    </div><!-- /.navbar-collapse -->
  </div><!-- /.container-fluid -->
</nav>
